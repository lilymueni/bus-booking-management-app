  ...
  return (
    <div className="homepage-container">
      ...
      <header className="hero">
        ...
        <img
  src="https://media.istockphoto.com/id/1472071952/vector/electric-city-bus-charging-station-with-green-city-city-building-in-background-vector.jpg?s=612x612&w=0&k=20&c=mpWPr_3_9YAlQIQ4EArllVY910o9lb3yMtbEUo7kcyo="
  alt="Electric city bus charging station with green city buildings in the background"
/>
